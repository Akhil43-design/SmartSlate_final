...
const db = new sqlite3.Database(dbPath, (err) => {
    if (err) {
        ...
        console.log('[SQLite B.Tech] Database initialized:', dbPath);
...
async function initTables() {
    try {
        ...
        console.log('[SQLite B.Tech] Tables initialized successfully.');
    } catch (err) {
        console.error('[SQLite B.Tech] Error initializing tables:', err.message);
    }
}

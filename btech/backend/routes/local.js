...
router.post('/profile', async (req, res) => {
    ...
    try {
        ...
        console.log(`[SQLite B.Tech] Profile saved for UID: ${firebase_uid}`);
...
router.post('/notes', async (req, res) => {
    ...
    try {
        ...
        console.log(`[SQLite B.Tech] Note saved locally for UID: ${firebase_uid} (ID: ${note_id})`);

    ...
    <div className="animate-pop-in space-y-6 py-2">
      ...
      <GlassCard className="rounded-[2.5rem] p-7 text-center bg-card shadow-soft border-2 border-primary/20">
        ...
        <p className="font-sans text-base font-bold text-muted-foreground">
          {student.grade} · Section {student.section} · {student.schoolName}
        </p>
      ...
      <div className="pt-2">
        <Link
          to="/login"
          className="soft-glass flex items-center justify-center gap-2 rounded-[2rem] p-4 text-center font-display text-base font-extrabold uppercase text-muted-foreground hover:text-red-600 hover:bg-red-50 transition-colors"
        >

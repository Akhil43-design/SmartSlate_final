...
app.get('/health', (req, res) => {
    res.json({ status: 'ok', app: 'SmartSlate-Intermediate-Diploma', version: '2.0.0', uptime: process.uptime() });
});
...
async function startServer() {
    try {
        ...
        server.listen(PORT, '0.0.0.0', () => {
            console.log(`=======================================================`);
            console.log(`🟢 SmartSlate Intermediate App running on http://localhost:${PORT}`);
            console.log(`=======================================================`);
        });
    } catch (err) {

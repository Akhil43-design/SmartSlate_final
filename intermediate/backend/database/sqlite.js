...
const db = new sqlite3.Database(dbPath, (err) => {
    if (err) {
        ...
        console.log('[SQLite Intermediate] Database initialized:', dbPath);
...
async function initTables() {
    try {
        ...
        console.log('[SQLite Intermediate] Tables initialized successfully.');
    } catch (err) {
        console.error('[SQLite Intermediate] Error initializing tables:', err.message);
    }
}

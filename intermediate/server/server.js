...
try {
    ...
    console.warn('[Intermediate Server] Route import warning:', e.message);
}

app.get('/health', (req, res) => {
    res.json({ status: 'ok', service: 'smartslate-intermediate-backend', port: PORT });
});

app.listen(PORT, () => {
    console.log(`🟢 [SmartSlate Intermediate OS] Server running on http://localhost:${PORT}`);
});

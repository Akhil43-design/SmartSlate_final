...
const SettingsView = {
    render(container) {
        const studentInfo = AcademicData.studentProfile || {
            name: "Aarav Sharma",
            rollNo: "24",
            classNum: 8,
            section: "Section B",
            academicYear: "2026–27",
            school: "SmartSlate Model Academy",
            studentId: "SS-2026-8042"
        };
    ...
    showReportCardModal(termTitle) {
        const studentInfo = AcademicData.studentProfile || { name: 'Aarav Sharma', classNum: 8, section: 'Section B' };
        const html = `
            <div class="modal-card" style="max-width: 540px; text-align: left;">
                <div class="modal-header">
                    <div>
                        ...
                        <div style="font-size: 12px; color: #6B7280; margin-top: 2px;">${termTitle} • Class ${studentInfo.classNum} • ${studentInfo.section}</div>
                    </div>
